...
work_dir = f'/home/yulingwu/CCS_place_grid/Storing_multiple_maps/test/result_20250715/neuron_num'
...
for place_num, grid_num in zip(place_nums, grid_nums):
  ...
  for k in range(simulaiton_num):
    ...
    while bump_score_diff >= 0.2:
      ...
      def cosine_similarity(a, b): # Change all bump score calculations to this
